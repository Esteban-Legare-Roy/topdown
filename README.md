...
// =========================
// Server (Node/Express/Socket.IO) — save as server.js at project root
// =========================
// Run: npm i express socket.io compression helmet && node server.js
// Folder:
//  project/
//   server.js
//   public/index.html public/game.js public/assets/*
/* server.js */
/*
